...
namespace EdiHelper
{
    public class EdiDocumentBuilderDeprecated
    {
        private readonly IEdiObjectReaderDeprecated _reader;

        public EdiDocumentBuilderDeprecated(IEdiObjectReaderDeprecated reader)
        {
            _reader = reader;
        }
